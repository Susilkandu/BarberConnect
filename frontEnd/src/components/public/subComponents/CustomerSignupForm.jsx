    ...
    if (Cookies.get("customerToken")) {
      (async () => {
        await requestHandler(
          dispatch,
          () => customerServices.getRegistrationStep(),0,
          {
            onSuccess: (res) => {
    ...
    try {
      switch (step) {
        case 1.0: {
          ...
          await requestHandler(
            dispatch,
            () => customerServices.sendOtpOnEmailForReg({ email }),0,
            {
              onSuccess: (res) => {
                console.log("hello")
        ...
        case 1.1: {
          ...
          await requestHandler(
            dispatch,
            () => customerServices.verifyOtpForReg({ email, otp }),1,
            {
              onSuccess: (res) => {
        ...
        case 2: {
          ...
          await requestHandler(
            dispatch,
            () => customerServices.SaveBasicInfoForReg({ name, gender, phone }),1,
            {
              onSuccess: (res) => {
