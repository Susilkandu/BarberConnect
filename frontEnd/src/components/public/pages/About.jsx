...
const About = () => {
  ...
  return (
    <div className="bg-[#FFFFF] text-white mb-8">
      {/* Hero Parallax Section */}
      <div
        className="relative h-[60vh] flex items-center justify-center bg-fixed bg-center bg-cover"
        style={{
          backgroundImage:
            "url('https://trafft.com/wp-content/uploads/2021/04/bar-header-768x512.webp')",
        }}
      >
        <div className="bg-black bg-opacity-60 p-6 rounded-xl text-center max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Not Just A Salon Platform</h1>
          <p className="text-lg text-gray-300">
            A movement born from roots, mirrors, and real human stories.
          </p>
        </div>
      </div>
      ...
      <div className="p-6 md:p-12 space-y-8 max-w-5xl mx-auto">
        ...
        <div className="bg-[#1F2937] p-6 rounded-2xl shadow-lg">
          <h2 className="text-2xl font-semibold mb-2">🌍 Bigger Than Code</h2>
          <p className="text-gray-300">
            This isn't just a tech platform. It’s an emotional bridge between art and audience, between creators and community. From booking to review — it's designed for soul-satisfaction.
          </p>
        </div>

        <div className="text-center pt-6">
          <button className="bg-yellow-500 hover:bg-yellow-400 text-black px-6 py-3 rounded-full font-semibold shadow-md transition-all">
            Join The Journey ✂️
          </button>
        </div>
      </div>
